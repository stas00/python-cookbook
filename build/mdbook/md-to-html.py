...
This is an ebook version of [Stas' Python Cookbook by Stas Bekman](https://github.com/stas00/python-cookbook/) generated on {date}.

As this book is constantly being updated, if you downloaded it as a pdf or an epub file and the date isn't recent, chances are that it's already outdated - make sure to check the latest version at [https://github.com/stas00/python-cookbook](https://github.com/stas00/python-cookbook).
""")
